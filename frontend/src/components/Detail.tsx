...
function Detail() {
  ...
  return (
    <>
      ...
      <div className="flex justify-center border-t-8 border-green-700 py-2">
        <div className='flex justify-center items-center h-full'>
          <h2>HN</h2>
          <input type="text" placeholder="HN" className="input input-bordered flex items-center gap-2 mx-3" disabled 
            value={HN}
      ...
      <div className="flex justify-center my-1">
        <div className='flex justify-center items-center h-full'>
          <h2>เบอร์ติดต่อ</h2>
          <input type="text" placeholder="เบอร์ติดต่อ" className="input input-bordered flex items-center gap-2 mx-3" 
            value={phone}
      ...
      <div className="flex justify-center border-b-8 border-green-700 py-2 space-x-1.5">
